    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        ...
        <Select value={statusFilter} onValueChange={handleStatusChange}>
          <SelectTrigger className="w-full sm:w-48 h-9 text-sm border-gray-200">
      ...
      <div className="rounded-lg border border-gray-100 overflow-hidden bg-white">
        {/* Header */}
        <div className="grid grid-cols-[200px_1fr_120px_180px_100px_80px_140px_140px] gap-4 px-4 py-3 bg-gray-50 border-b border-gray-100 text-xs font-semibold text-gray-500">
          <div>ID Orden</div>
          <div>Cliente</div>
              ...
              {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[200px_1fr_120px_180px_100px_80px_140px_140px] gap-4 px-4 py-3 border-b border-gray-50 hover:bg-blue-50/40 cursor-pointer transition-colors absolute top-0 left-0 w-full"
                    style={{
                  ...
                  >
                    <div className="flex flex-col gap-0.5">
                      <div className="flex items-center gap-1.5">
                        ...
                        {order.isCyberOrder && (
                          <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-purple-100 text-purple-700 rounded text-[10px] font-bold border border-purple-200">
                            <span>⚡</span>
                            CYBER
                          </span>
                        )}
                      </div>
                      <span className="font-mono text-[10px] text-gray-400 select-all truncate">
                        {order.orderId}
                      </span>
                    </div>
                    ...
                    <div className="text-xs text-gray-500">{order.origin || '—'}</div>
                    <div className="text-xs text-gray-500 hidden md:block text-center">
                      {order.totalItems ?? '—'}
                    </div>
